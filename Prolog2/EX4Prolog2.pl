% EXERCICIO 4 - DISCIPLINA RAIZ E FOLHA
% Base de dados
...
% =====================================================
% REGRAS DO EXERCÍCIO 4
% =====================================================

% 1) disciplina_raiz(D):
%    D é disciplina raiz se NÃO tiver nenhum pré-requisito.
disciplina_raiz(D) :-
    disciplina(D, _, _),
    \+ prerequisito(D, _).

% 2) disciplina_folha(D):
%    D é disciplina folha se NÃO for pré-requisito de nenhuma outra disciplina.
disciplina_folha(D) :-
    disciplina(D, _, _),
    \+ prerequisito(_, D).

% 3) Query pedida no enunciado (exemplo de uso):
